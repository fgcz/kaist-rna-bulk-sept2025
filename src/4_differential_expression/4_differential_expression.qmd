...
2.  BH (Benjamin-Hochberg), otherwise known as the false discovery ratex
...
resLFC <- correctDESeq2Output(lfcShrink(dds, coef=resultsName, type="normal"), isValid)
...
Since this is the case for our yeast experiment, using ORA this is the recommended way. First, let's split our genes into up-regulated and down-regulated.
...
clusterProfiler::cnetplot(ego, 
                          ...
                          cex.params = list(gene_label = 0.3,
                                            category_label = 0.7))

# Plot goplot
clusterProfiler::goplot(ego,
                        cex.params = list(category_label = 0.2))
```
