...
meta <- data.frame(
  Condition=c(rep("Glucose", 4), rep("GlycEth", 4)),
...
toPlot <- tibble(
  ...
  `Fraction of features above threshold`=colSums(rawCounts > 10),
  Percentages=paste(signif(100 * colSums(rawCounts > 10) / nrow(rawCounts), digits=2), "%")
)
