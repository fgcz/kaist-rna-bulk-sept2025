...
# First, let's create a transcriptome fasta from our GTF
REFERENCE_FASTA=~/work/grch38-p13-gencode-release-42/sequence/GRCh38.p13.genome.fa
FILTERED_GTF=~/work/results/tmp/genes_protein_coding.gtf
TRANSCRIPTOME_FASTA=~/work/results/tmp/transcriptome_protein_coding.fa

# Extract transcriptome (this is a simplified approach)
# In practice, you would use gffread or similar tools
...
# For the tutorial, we'll simulate kallisto runs
# In practice, you would need a proper transcriptome index
echo "Kallisto quantification would be run here"
echo "This requires a pre-built transcriptome index which is not available in this tutorial"

# The following would be the actual kallisto commands (commented out):
# for FASTQ_R1 in $FASTP_OUTDIR/*_R1.fastq.gz
#   do SAMPLE_NAME=$(basename ${FASTQ_R1%_trimmed_R1.fastq.gz})
#   FASTQ_R2="${FASTP_OUTDIR}/${SAMPLE_NAME}_trimmed_R2.fastq.gz"
#   echo $SAMPLE_NAME
#   time kallisto quant \
#     -i transcriptome_index.idx \
#     -o $KALLISTO_OUTDIR/$SAMPLE_NAME -t 4 --bias --bootstrap-samples 10 --seed 42 \
#     $FASTQ_R1 $FASTQ_R2 \
